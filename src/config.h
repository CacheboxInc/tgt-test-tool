...
#define HAVE_CU_SUITEINFO_PSETUPFUNC 1
...
/* Whether we have SG_IO support */
#define HAVE_SG_IO 1

/* Whether we have IPv6 support */
...
#define PACKAGE_STRING "libiscsi 1.18.0"
